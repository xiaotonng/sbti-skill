...
SBTI 的爆火堪称中文互联网 2026 年最魔幻的事件之一。一个为了劝朋友戒酒而做的小测试，在不到 **12 小时**内席卷了整个中文互联网。

```mermaid
timeline
    title SBTI 爆火全记录 · 2026年4月8日—9日
    section 🌱 诞生
      4月8日 晚间
        : B站 UP主「蛆肉儿串儿」发布视频
    ...
    section 🔥 点燃
      4月9日 凌晨—上午
        ...
        : 测试链接在弹幕和评论区扩散
        : 早起的网友开始在朋友圈分享测试结果
        : "我居然是个死者" "我是吗喽" 等截图开始出现
    section 💥 爆发
      4月9日 中午—下午
        : #SBTI测试# 冲上微博热搜
        : 瞬时流量激增，原始测试网站 w99.site 被挤崩
    ...
    section 🌊 蔓延
      4月9日 下午—傍晚
        ...
        : 多个镜像站上线：sbti.dev、sbti.jerryz.com.cn 等
        : V2EX、LINUX DO 等社区跟进讨论
        : 测试从学生群体蔓延到职场白领
    section 🌍 全民狂欢
      4月9日 晚间—4月10日
        : 微信朋友圈被 SBTI 结果截图刷屏
        : 海外社交平台 X/Twitter 出现英文讨论
        : 媒体跟进报道（游民星空、腾讯新闻、新浪、网易等）
        : 维基百科、百度百科同步建立词条
        : B站原视频播放量突破 66 万，弹幕 544，点赞 3.3 万，转发 2.1 万
```
...
```mermaid
xychart-beta
    title "SBTI 传播热度趋势（2026年4月8日—10日）"
    x-axis ["8日 20:00", "8日 23:00", "9日 02:00", "9日 06:00", "9日 09:00", "9日 12:00", "9日 15:00", "9日 18:00", "9日 21:00", "9日 24:00", "10日 06:00", "10日 12:00"]
    y-axis "热度指数" 0 --> 100
    line [2, 5, 8, 12, 25, 68, 95, 100, 92, 85, 70, 60]
```
...
| 4/8 晚 | 视频首发 | B站 | ▓░░░░ |
| 4/9 上午 | 朋友圈扩散 | 微信 · B站 | ▓▓░░░ |
| 4/9 中午 | 冲上微博热搜 | 微博 · 微信 · B站 | ▓▓▓░░ |
| 4/9 下午 | 网站崩溃 + 镜像站涌现 | 全平台 | ▓▓▓▓░ |
| 4/9 傍晚 | 全民测试 + 媒体跟进 | 全平台 + 传统媒体 | ▓▓▓▓▓ |
| 4/10 | 持续发酵 · 二创涌现 | 全平台 | ▓▓▓▓░ |
